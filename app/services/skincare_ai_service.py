...
def generate_fallback_skincare_advisor(
    ...
    if any(k in msg_lower for k in ["order", "oder", "ordar", "kinbo", "kinte", "buy", "kivabe order", "kivabe oder", "kibhabe order", "ki bhabe order", "ki bhabe oder", "অর্ডার", "কিনব", "কিনতে", "পারচেজ", "খরিদ", "ক্রয়"]):
        ...
        concern_intro = (
            ...
            "   - **ঢাকার ভেতরে**: ডেলিভারি ফি ৳৬০ ($২.০০) — ১-২ কার্যদিবসে ডেলিভারি\n"
            "   - **ঢাকার বাইরে**: ডেলিভারি ফি ৳১২০ ($৪.০০) — ৩-৫ কার্যদিবসে ডেলিভারি\n"
    ...
    # 2. Price & Cost Inquiry Intent
        ...
        concern_intro = (
            ...
            "- **ডেলিভারি চার্জ (ঢাকার ভেতরে)**: ৳৬০ ($২.০০)\n"
            "- **ডেলিভারি চার্জ (ঢাকার বাইরে)**: ৳১২০ ($৪.০০)\n"
        ...
        suggested_q = [
            ...
            "কোন প্রোডাক্টে ডিসকাউন্ট অফার আছে?"
        ]
        is_non_routine_intent = True
    ...
    # 3. Delivery & Shipping Inquiry Intent
        ...
        concern_intro = (
            ...
            "- **ঢাকার ভেতরে**: ডেলিভারি সময় ১-২ কার্যদিবস | ফি: ৳৬০ ($২.০০)\n"
            "- **ঢাকার বাইরে**: ডেলিভারি সময় ৩-৫ কার্যদিবস | ফি: ৳১২০ ($৪.০০)\n\n"
