...
def generate_fallback_skincare_advisor(
    ...
    if any(k in full_context_text for k in ["kalo dag", "kalodag", "cokher", "chokher", "dark spot", "dark circle", "pigmentation", "mecheta", "mechota", "চোখের", "কালো দাগ", "মেচেতা", "দাগ"]):
        if is_answering:
            ...
            concern_intro = (
                "আপনার উত্তরগুলোর জন্য ধন্যবাদ। চোখের নিচের ত্বকের পাতলাতা ও কালচে ভাব (Periorbital Hyperpigmentation) নিরাময়ে সঠিক চিকিৎসাসংক্রান্ত গাইডলাইন দেওয়া হলো:\n\n"
                "💡 **চিকিৎসাসংক্রান্ত প্রেসক্রিপশন & রুটিন:**\n"
                "১. **ক্যাফেইন & ভিটামিন-সি আই সিরাম**: চোখের নিচের কালচে ভাব দূর করতে ক্যাফেইন বা নিয়াসিনামাইড যুক্ত আই সিরাম অনামিকা আঙুল দিয়ে আলতো প্যাট করে লাগান।\n"
                "২. **নাইট আই ক্রিম**: রাতে ঘুমানোর আগে হাইড্রেটিং পেপটাইড বা রেটিনল আই ক্রিম ব্যবহার করুন।\n"
                "৩. **সানস্ক্রিন সুরক্ষা**: বাইরে বের হলে চোখের চারপাশে সানস্ক্রিন বা রোদচশমা ব্যবহার নিশ্চিত করুন।\n\n"
                "🛌 **লাইফস্টাইল পরামর্শ**: রাত ১১টার মধ্যে ঘুম নিশ্চিত করুন এবং দিনে অন্তত ৩ লিটার পানি পান করুন।"
            )
            voice_text = "আপনার উত্তরগুলোর জন্য ধন্যবাদ। চোখের নিচের কালো দাগ দূর করতে নিয়মিত ক্যাফেইন আই সিরাম ও পর্যাপ্ত ঘুম অত্যন্ত কার্যকরী।"
            suggested_q = [
                "চোখের নিচের জন্য কোন আই সিরাম ভালো?",
                "আই সিরাম কীভাবে ব্যবহার করব?",
                "কালো দাগ কতদিনে দূর হবে?"
            ]
        else:
            concern_title = "🩺 ড. SUPRITS ডার্মাটোলজিক্যাল এ্যাসেসমেন্ট: চোখের নিচের কালো দাগ ও কালচে ছোপ"
            concern_intro = (
                ...
                "১. কালচে দাগের অনুভূতি: আপনি কি কখনও চোখের নিচে চুলকানি বা অস্বস্তি অনুভব করেন?\n"
                "২. সমস্যার সময়কাল: এই কালো দাগগুলো কতদিন ধরে আছে?\n"
                "৩. বর্তমান রুটিন: আপনি কি চোখের নিচে কোনো বিশেষ ক্রিম বা সিরাম ব্যবহার করছেন?"
            )
            voice_text = "আমি ডক্টর সুপ্রিটস। চোখের নিচের কালো দাগ দূর করতে প্রতিদিন আই কেয়ার ও সানস্ক্রিন ব্যবহার আবশ্যক।"
            suggested_q = [
                "আমার চোখের নিচে কালো দাগ হয়েছে",
